...
namespace AzureServiceBusDemo
{
    class Program
    {
        ...
        {
            var serviceBusConnectionString = "Endpoint=sb://dotnetservicebus.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=+FdSphB3xrcAY4lfzAY2D/9+YU301BAzGxp+pkvhjiI=";
