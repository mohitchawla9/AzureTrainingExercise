...
namespace AzureTrainingExercise.BusinessLayer
{
    public class BlobManager
    {
        ...
        public BlobManager(string ContainerName)
        {
            ...
            try
            {
                ...
                string ConnectionString = "DefaultEndpointsProtocol=https;AccountName=dotnetdevsa;AccountKey=8m3DeO1Y307bdOLFrB62ttk0fyrNrPHw6txjkDRfwdVS//iO5oN/WO7ymS6VqGJ+24KjT90nTxNKDEwwvR1VcQ==;EndpointSuffix=core.windows.net";
